...
const POSITIVE_GOALS = [
  ...
  { id: 'forget-self', icon: CircleDot, label: 'Forget myself', de: 'Sich ganz vergessen jetzt' },
  { id: 'intimacy', icon: Heart, label: 'Find intimacy', de: 'Intimität heute finden hier' },
  { id: 'hydrate', icon: GlassWater, label: 'Stay hydrated', de: 'Immer genug Wasser trinken' },
  { id: 'safe', icon: Shield, label: 'Priority: Safety', de: 'Sicherheit ist höchste Priorität' },
  { id: 'discover', icon: Target, label: 'Discover music', de: 'Neue Musik heute entdecken' },
];

const NEGATIVE_GOALS = [
  { id: 'no-mixing', icon: Ban, label: 'Avoid mixing', de: 'Kein Mischen heute Abend' },
  { id: 'limit-dose', icon: ZapOff, label: 'Limit intake', de: 'Dosis heute gering halten' },
  { id: 'early-end', icon: Clock, label: 'Leave early', de: 'Heute früh nach Hause' },
  { id: 'no-alcohol', icon: GlassWater, label: 'No alcohol', de: 'Keinen Alkohol heute trinken' },
  { id: 'rest-breaks', icon: Moon, label: 'Take breaks', de: 'Pausen machen heute Abend' },
];

const RESONANCE_GOALS = [
  { id: 'radiate-presence', icon: Radio, label: 'Radiate Presence', de: 'Präsenz heute ausstrahlen hier' },
  { id: 'deep-listening', icon: Ear, label: 'Deep Listening', de: 'Tiefes Zuhören heute üben' },
  { id: 'shining-love', icon: Heart, label: 'Shining with Love', de: 'Mit Liebe heute strahlen' },
];

const UI = {
  EN: { header: 'Your focus', sub: 'What is your main focus?', res: 'The Resonance', pos: 'Positive Intentions', neg: 'Safety Boundaries', confirm: 'Confirm goals' },
  DE: { header: 'Dein Fokus', sub: 'Was ist dein Hauptfokus?', res: 'Die Resonanz', pos: 'Positive Intentionen', neg: 'Sicherheitsgrenzen', confirm: 'Ziele bestätigen' }
};
