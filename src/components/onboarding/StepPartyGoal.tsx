...
/**
 * @fileOverview Party Goals selection.
 * Languages: EN, DE, PT.
 */

const POSITIVE_GOALS = [
  { id: 'dance', icon: Music, label: 'Dance all night', de: 'Die ganze Nacht tanzen', pt: 'Dançar a noite toda' },
  { id: 'social', icon: Users, label: 'Meet new people', de: 'Neue Leute treffen', pt: 'Conhecer novas pessoas' },
  { id: 'forget-self', icon: CircleDot, label: 'Forget myself', de: 'Sich vergessen', pt: 'Me esquecer' },
  { id: 'intimacy', icon: Heart, label: 'Find intimacy', de: 'Intimität finden', pt: 'Encontrar intimidade' },
  { id: 'hydrate', icon: GlassWater, label: 'Stay hydrated', de: 'Hydriert bleiben', pt: 'Manter a hidratação' },
  { id: 'safe', icon: Shield, label: 'Priority: Safety', de: 'Priorität: Sicherheit', pt: 'Prioridade: Segurança' },
  { id: 'discover', icon: Target, label: 'Discover music', de: 'Musik entdecken', pt: 'Descobrir música' },
];

const NEGATIVE_GOALS = [
  { id: 'no-mixing', icon: Ban, label: 'Avoid mixing', de: 'Kein Mischen', pt: 'Evitar misturas' },
  { id: 'limit-dose', icon: ZapOff, label: 'Limit intake', de: 'Dosis begrenzen', pt: 'Limitar consumo' },
  { id: 'early-end', icon: Clock, label: 'Leave early', de: 'Früh gehen', pt: 'Sair cedo' },
  { id: 'no-alcohol', icon: GlassWater, label: 'No alcohol', de: 'Kein Alkohol', pt: 'Sem álcool' },
  { id: 'rest-breaks', icon: Moon, label: 'Take breaks', de: 'Pausen machen', pt: 'Fazer pausas' },
];

const RESONANCE_GOALS = [
  { id: 'radiate-presence', icon: Radio, label: 'Radiate Presence', de: 'Präsenz ausstrahlen', pt: 'Irradiar Presença' },
  { id: 'deep-listening', icon: Ear, label: 'Deep Listening', de: 'Tiefes Zuhören', pt: 'Escuta profunda' },
  { id: 'shining-love', icon: Heart, label: 'Shining with Love', de: 'Mit Liebe strahlen', pt: 'Brilhando com Amor' },
];
